...
func build() *gcode.Dialect {
	...
	d.Register(gcode.CommandDef{Name: "EXCLUDE_OBJECT_DEFINE", Description: "declare a printable object", Params: []gcode.ParamDef{{Key: "NAME", Required: true}, {Key: "CENTER"}, {Key: "POLYGON"}}})
	...
	d.Register(gcode.CommandDef{Name: "SET_FAN_SPEED", Description: "set named fan speed", Params: []gcode.ParamDef{{Key: "FAN", Required: true}, {Key: "SPEED"}}})
	...
	d.Register(gcode.CommandDef{Name: "BED_MESH_PROFILE", Description: "load/save/remove a bed mesh profile", Params: []gcode.ParamDef{{Key: "LOAD"}, {Key: "SAVE"}, {Key: "REMOVE"}}})
